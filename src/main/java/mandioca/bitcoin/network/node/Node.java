...
public class Node {
    ...
    private class NodeDependencyInjectionModule extends AbstractSimpleModule {
        ...
        public void configure() {
            ...
            createSingletonMapping(Selectors.class, selectors);
            createSingletonMapping(SocketChannelQueues.class, socketChannelQueues);
            createSingletonMapping(HandshakeCache.class, handshakeCache);
        }
    }
